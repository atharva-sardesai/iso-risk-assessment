...
export const initialRiskAssessments: RiskAssessment[] = [
  {
    ...
    treatmentPlan:
      "Implement multi-factor authentication, password complexity requirements, and regular password rotation",
  },
  {
    id: "risk-2",
    ...
    treatmentPlan: "Implement prepared statements, input validation on server side, and regular security testing",
  },
  {
    id: "risk-3",
    asset: "Employee Workstations",
    threat: "Malware Infection",
    vulnerability: "Outdated antivirus software and operating systems",
    impact: "Medium",
    likelihood: "High",
    riskLevel: "High",
    existingControls: "Basic antivirus software",
    treatmentPlan:
      "Implement centralized patch management, update all systems, and provide security awareness training",
  },
  {
    id: "risk-4",
    ...
    treatmentPlan: "Implement DDoS protection service, increase bandwidth capacity, and configure traffic filtering",
  },
  {
    id: "risk-5",
    ...
    treatmentPlan:
      "Implement 3-2-1 backup strategy with offsite and cloud backups, regular testing of restoration process",
  },
  {
    id: "risk-6",
    asset: "Customer Data",
